...
(0, _avalon.component)('ms-hashrouter', {
    ...
    defaults: {
        ...
        onInit: function onInit(e) {
            _router2.default.routerComponent = e.vmodel;
        },
        onReady: function onReady(e) {
            var _this = this;
            ...
            urlsplits.forEach(function (el) {
                ...
                if (routeVmodel) {
                    ...
                    routeVmodel.visibleComponent = '<' + routeVmodel.component + ' ms-widget="{query:params}" />';
                }
            });
            this.visibleRoute = visiblePath;
        },
...
(0, _avalon.component)('ms-route', {
    template: '<div ms-css="styles" ms-html="visibleComponent" ms-visible="visible"></div>',
    defaults: {
        styles: {
            width: '100%',
            height: '100%'
        ...
        onInit: function onInit(e) {
            ...
            var rootComp = _router2.default.routerComponent;
            rootComp.routes[this.path] = e.vmodel;
            _router2.default.route(_this.path, function () {
                _this.visible = true;
                _this.visibleComponent = '<' + _this.component + ' ms-widget="{query:params}" />';

                var currCompVmodel = rootComp.routes[rootComp.visibleRoute];
                if (currCompVmodel) {
                    currCompVmodel.visibleComponent = '';
                    currCompVmodel.visible = false;
                }

                rootComp.visibleRoute = _this.path;
            });
        },
        onReady: function onReady(e) {}
    }
...
module.exports = "<a class=\"nav-link\" ms-attr=\"{href:getHref(to)}\" ms-click=\"click\">\r\n    <span><slot /></span>\r\n</a>\r\n"
